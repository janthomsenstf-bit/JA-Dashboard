...
export const HAUPTBEREICHE = [
  ...
  { key: 'aufgaben',     label: 'Aufgaben',      icon: '📋', farbe: '#7c3aed', beschreibung: 'Alles mit Datum an einem Ort – Fristen, Aufgaben, Aufträge, Termine und Erinnerungen.' },
  { key: 'auftraege',    label: 'Aufträge',      icon: '📑', farbe: '#2563eb', beschreibung: 'Nur die echten Aufträge aller Mandanten – ohne automatische Fristen und Notizzettel.' },
