...
export default function GlobalTodoView({ clients, aufgabenListe = [], onUpdateAufgabe, onAddAufgabe, onUpdateClient, onSelectClient, onNavigateToAuftrag, modus = 'alle' }) {
  // modus 'auftraege' → Quellen-Filter startet auf „Aufträge"
  // modus 'alle'      → Quellen-Filter startet auf „Alle Quellen"
  ...
  async function exportierenExcel() {
    ...
    if (viewMode === 'mandanten' && !sucheAktiv) {
    ...
    const ansichtText = sucheAktiv ? `Suche „${suche.trim()}"`
    ...
    sheets.push({ name: 'Filter', rows: [
      ...
      ['Ansicht', ansichtText],
      ['Zeitraum', sucheAktiv ? 'alle (ohne Zeitgrenze)'
        ...
        <div style={{ display:'flex', alignItems:'center', gap:'10px', marginBottom:'10px', flexWrap:'wrap' }}>
          ...
          <div>
            <div style={{ fontWeight:800, fontSize:'15px' }}>
              {nurAuftraege ? 'Auftrags-Übersicht' : 'Aufgaben & Fristen'}
            </div>
